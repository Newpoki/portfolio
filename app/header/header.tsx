...
export const Header = () => {
  return (
    <div className="main-layout-px sticky top-0 z-50 mb-8 flex items-center justify-between border-b border-b-border py-4 backdrop-blur supports-[backdrop-filter]:bg-background/60">
